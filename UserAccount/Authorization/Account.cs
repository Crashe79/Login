...
namespace UserAccount.Authorization
{
    ...
    public class Account
    {
        ...
        public List<AccountSocNt> SocialNetModels { get; set; }
        ...
        public Account(DAL.UserAccount account, bool staySignedIn)
        {
            ...
            SocialNetModels = GetListAccountSocNt(account.SocialNetModels);
        ...
        public List<AccountSocNt> GetListAccountSocNt(IEnumerable<SocialNetModel> models)
        {
            var socs = new List<AccountSocNt>();
            foreach (var item in models)
            {
                socs.Add(new AccountSocNt(item));
            }
            return socs;
        } 
    }
