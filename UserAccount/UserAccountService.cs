...
namespace UserAccount
{
    public class UserAccountService : IUserAccountService
    {
        ...
        private DAL.UserAccount GetCurrentUser()
        {
        ...
        public string SignIn(RegistrationTokenModel registrationTokenModel, string culture)
        {
            if (!IsSocialNtAccountExsist(registrationTokenModel.Provider, registrationTokenModel.Account))
                return RegistrationUserBySocialNT(registrationTokenModel, culture);
        ...
        private DAL.UserAccount RegistrationUserAccountBySocialNet(DAL.UserAccount userAccount)
        {
        ...
        private DAL.UserAccount LoginBySocialNt(string socialNtName, string socialNtAccount, bool rememberMe = true)
        {
            ...
            new FormsAuthenticationService(context).SignIn(user, socialNtName, socialNtAccount, rememberMe);
        ...
        private bool IsSocialNtAccountExsist(string provider, string account)
        {
            return repository.IsSocialNtAccountExsist(provider, account);
        }

        private string RegistrationUserBySocialNT(RegistrationTokenModel registrationTokenModel, string culture)
        {
